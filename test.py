...
def create_center_button(window):  # Button mittig platzieren (Zeile 4,14)
    button = ttk.Button(window, text="START")  # minimalistischer Button (verwendet Zeile 2)
    button.configure(command=lambda: print("FUTURE ACTIVATED"))  # Klick-Aktion (Terminal-Output)
